Shader "Custom/Sprites/Screen"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float Screen(float base, float top)
			{
			...
			fixed4 ComputeFragment (VertexOutput vertexOutput) : SV_Target
			{
				...
				color.r = Screen(grabColor.r, color.r);
				color.g = Screen(grabColor.g, color.g);
				color.b = Screen(grabColor.b, color.b);
				color.rgb *= color.a;
				return color;
			}
			ENDCG
